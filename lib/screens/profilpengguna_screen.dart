...
class ProfilPenggunaScreen extends StatefulWidget {
  const ProfilPenggunaScreen({super.key});

  @override
  State<ProfilPenggunaScreen> createState() => _ProfilPenggunaScreenState();
}
...
class _ProfilPenggunaScreenState extends State<ProfilPenggunaScreen> {
  ...
  // TODO: 5. Implementasi fungsi Login
  void signIn () {
    setState(() {
      isSignedIn = !isSignedIn;
    });
  }
  // TODO: 6. Implementasi fungsi Logout
  void signOut () {
    setState(() {
      isSignedIn = !isSignedIn;
    });
